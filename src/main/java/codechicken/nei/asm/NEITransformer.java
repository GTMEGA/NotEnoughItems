...
public class NEITransformer implements IClassTransformer {
    ...
    public NEITransformer() {
        ...
        transformer.add(new MethodInjector(
        ...
        transformer.add(
                new MethodTransformer(new ObfMapping(
                    ...
                    public void transform(MethodNode mv) {
                        ...
                        InsnListSection key = findN(mv.instructions, asmblocks.get("n_workbenchFix").list)
                                .get(0);
        ...
        // add manager field
        transformer.add(new FieldWriter(
                ACC_PUBLIC, new ObfMapping(GuiContainer, "manager", "Lcodechicken/nei/guihook/GuiContainerManager;")));
        ...
        transformer.add(new MethodWriter(
                ACC_PUBLIC, new ObfMapping(GuiContainer, "func_146274_d", "()V"), asmblocks.get("m_handleMouseInput")));
        ...
        transformer.add(new MethodInjector(
                new ObfMapping(GuiContainer, "func_73863_a", "(IIF)V"), asmblocks.get("preDraw"), true));
        ...
        transformer.add(new MethodReplacer(
                new ObfMapping(GuiContainer, "func_146982_a", "(Lnet/minecraft/item/ItemStack;IILjava/lang/String;)V"),
        ...
        transformer.add(new MethodInjector(
                new ObfMapping(GuiContainer, "func_73864_a", "(III)V"), asmblocks.get("mouseClicked"), true));
        ...
        transformer.add(new MethodInjector(
                new ObfMapping(GuiContainer, "func_146286_b", "(III)V"), asmblocks.get("overrideMouseUp"), true));
        ...
        transformer.add(new MethodInjector(
                new ObfMapping(GuiContainer, "func_73869_a", "(CI)V"), asmblocks.get("lastKeyTyped"), true));
        ...
        for (int i = 0; i < 3; i++) {
            ObfMapping m = new ObfMapping(
                    "net/minecraft/client/gui/inventory/GuiBeacon$" + buttons[i], "func_146111_b", "(II)V");
    ...
    private final ObfMapping c_GuiContainer =
            new ObfMapping("net/minecraft/client/gui/inventory/GuiContainer").toClassloading();
    /**
