...
public class OptionKeyBind extends OptionButton {
    ...
    public boolean conflicted() {
        ...
        for (Option o : slot.options)
            if (o instanceof OptionKeyBind && o != this && ((OptionKeyBind) o).getValue() == getValue()) return true;
    ...
    public String getButtonText() {
        ...
        if (conflicted()) return EnumChatFormatting.RED + Keyboard.getKeyName(getValue());
