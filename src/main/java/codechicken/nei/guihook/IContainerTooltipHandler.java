 ...
 * handleItmeDisplayName will not be called
 */
public interface IContainerTooltipHandler {

    /**
     * Use this to add tooltips for other objects. If the current tip has lines in it after this call, the item tootip
     * will not be handled. GuiContainerManager.shouldShowTooltip is not enforced here. It is recommended that you make
     * this check yourself
     *
     ...
     *
     * @param gui        An instance of the currentscreen. If only general information about the item is wanted (Eg.
     *                   potion effects) then this may be null.
     ...
     * @param mousey The y position of the mouse in pixels from top
     */
    default Map<String, String> handleHotkeys(GuiContainer gui, int mousex, int mousey, Map<String, String> hotkeys) {
        return hotkeys;
    }
}
