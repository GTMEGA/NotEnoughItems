...
public interface IContainerInputHandler {
    ...
    /**
     * This version of keyTyped is called if the key event has not been handled by the first pass, use this for key
     * bindings that work globally
     * 
     * @param gui     An instance of the currentscreen
     * @param keyChar The character representing the keyPress
     * @param keyID   The KeyCode as defined in {@link Keyboard}
    ...
    /**
     * This version of mouseClicked is passive and will be called on every input handler before mouseClicked is
     * processed
     * 
     * @param gui    An instance of the currentscreen
     * @param mousex The x position of the mouse in pixels from left
