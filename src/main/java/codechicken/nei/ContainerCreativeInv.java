...
public class ContainerCreativeInv extends Container {
    ...
    private class SlotBlockArmor extends SlotArmor {
        ...
        @Override
        public boolean isItemValid(ItemStack stack) {
            return super.isItemValid(stack) || stack != null; // && Block.getBlockFromItem(stack.getItem()) !=
                                                              // Blocks.air;
        }
    }
    ...
    public ContainerCreativeInv(EntityPlayer player, ExtendedCreativeInv extraInv) {
        ...
        for (int armorType = 1; armorType < 4; armorType++) addSlotToContainer(
                new SlotArmor(
                        invPlayer,
                        invPlayer.getSizeInventory() - 1 - armorType,
                        -15,
                        23 + armorType * 18,
                        armorType));
    }
